...
Issue #33 requires a minimal operator control TUI built with Ink for
trading operation (demo/live modes). The control surface belongs with infrastructure concerns: health,
