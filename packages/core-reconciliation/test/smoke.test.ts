...
import { CORE_RECONCILIATION_VERSION } from "@agenttrading/core-reconciliation";
...
describe("@agenttrading/core-reconciliation smoke", () => {
  test("package resolves and depends only on contracts", () => {
    expectPackageSmoke(CORE_RECONCILIATION_VERSION, () => {
